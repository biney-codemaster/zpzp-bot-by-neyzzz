...
module.exports = {
  name: 'setwelcome', description: 'Configure le welcome', category: 'config', usage: '<salon|off> [message]', permLevel: 'admin',
  async execute(client, message, args) {
    ...
    return message.reply({ embeds: [success(`Welcome → ${channel}`)] });
  },
};
