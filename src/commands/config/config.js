      ...
      embeds: [
        new EmbedBuilder()
          ...
          .addFields(
            ...
            { name: 'Admin role', value: g.admin_role ? `<@&${g.admin_role}>` : 'None', inline: true },
            ...
            { name: 'Automod', value: `Link:${g.automod_antilink ? 'ON' : 'OFF'} Spam:${g.automod_antispam ? 'ON' : 'OFF'} Words:${g.automod_badwords ? 'ON' : 'OFF'}` }
          )
          .setTimestamp(),
      ],
    });
