...
module.exports = {
  name: 'greroll', description: 'Relance le tirage', category: 'giveaways', usage: '<message_id>', permLevel: 'mod',
  async execute(client, message, args) {
    ...
    return message.reply({ content: `Nouveau gagnant pour **${g.prize}** : <@${winner}>`, embeds: [success('Reroll effectué.')] });
  },
};
