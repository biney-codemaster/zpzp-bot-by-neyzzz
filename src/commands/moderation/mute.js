...
module.exports = {
  ...
  async execute(client, message, args) {
    ...
    return message.reply({
      embeds: [
        success(
          `**${member.user.tag}** muted for **${durationText}**. Case #${caseId}\n**Reason:** ${reason}`
        ),
      ],
    });
  },
