...
module.exports = {
  ...
  async execute(client, message, args) {
    ...
    await sendModLog(client, message.guild, { action: 'Unmute', moderator: message.author, target: member.user, reason });
    return message.reply({ embeds: [success(`**${member.user.tag}** n\'est plus mute.`)] });
  },
};
