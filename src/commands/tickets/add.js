...
module.exports = {
  ...
  async execute(client, message, args) {
    ...
    if (!ticket || ticket.closed) return message.reply({ embeds: [error('Ce salon n\'est pas un ticket.')] });
    ...
    return message.reply({ embeds: [success(`${member} a été ajouté au ticket.`)] });
  },
};
